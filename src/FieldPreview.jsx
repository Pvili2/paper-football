...
const FieldPreview = ({ rows, cols, size, onClick }) => {
    ...
    return (
        <motion.div
            ...
            whileHover={{
                scale: 1.05,
                boxShadow: '0 6px 8px rgba(0, 0, 0, 0.2), inset 0 0 30px rgba(255, 255, 255, 0.3)',
            }}
        ...
        >
            ...
            <motion.div
                ...
                animate={{
                    color: ['rgba(255, 255, 255, 0.7)', 'rgba(255, 255, 255, 1)', 'rgba(255, 255, 255, 0.7)']
                }}
                transition={{
                    duration: 2,
                    repeat: Infinity,
